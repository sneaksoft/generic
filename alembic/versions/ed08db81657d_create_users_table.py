...
Revision ID: ed08db81657d
Revises: 
Create Date: 2026-02-27 02:40:26.853852
...
def upgrade() -> None:
    ...
    sa.Column('oauth_provider_name', sa.String(length=64), nullable=True),
